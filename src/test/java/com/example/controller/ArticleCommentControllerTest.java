...
class ArticleCommentControllerTest {
    ...
    @Test
    void givenArticleCommentInfo_whenRequestSave_thenSaveNewArticleComment() throws Exception {
        // given
        long articleId = 1L;
    ...
    @Test
    void givenArticleCommentIdToDelete_whenRequestDelete_thenDeleteArticleComment() throws Exception {
        // given
        long articleId = 1L;
